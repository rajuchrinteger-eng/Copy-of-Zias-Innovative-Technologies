  ...
  return (
    <section className="relative pt-24 pb-36 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 -z-10">
        {/* Minimal high-tech / architectural background image */}
        <img 
        ...
        <div className="absolute top-[-20%] right-[-10%] w-[800px] h-[800px] bg-blue-50/80 rounded-full blur-[140px]"></div>
        <div className="absolute bottom-0 left-[-5%] w-[600px] h-[600px] bg-indigo-50/60 rounded-full blur-[120px]"></div>
      </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <h1 className="text-6xl md:text-8xl font-bold text-slate-900 leading-[1.05] mb-10 animate-fade-up tracking-tight">
          75+ Years of Retail<br />
          <span className="relative inline-block">
            Legacy.
            <div className="absolute bottom-4 left-0 w-full h-12 bg-blue-500/10 -z-10 blur-md"></div>
          </span>
        </h1>
