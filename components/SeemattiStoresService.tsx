      ...
      <section className="relative pt-24 pb-32 overflow-hidden bg-slate-900 text-white">
        ...
        <div className="container mx-auto px-6 relative z-10 animate-fade-up">
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            <button className="px-10 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold transition-all shadow-xl shadow-blue-900/20">
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto bg-slate-900 p-16 md:p-24 rounded-[60px] text-white relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 relative z-10">
            <button className="w-full sm:w-auto px-12 py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold transition-all">
              Contact Us
            </button>
