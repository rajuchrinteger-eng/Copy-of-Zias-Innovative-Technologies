          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 animate-fade-up">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <button className="px-12 py-5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full font-bold transition-all shadow-xl shadow-emerald-200">
                  Explore Courses
                </button>
                <button className="px-12 py-5 bg-white border border-slate-200 text-slate-900 rounded-full font-bold hover:bg-slate-50 transition-all shadow-sm">
                  Request a Demo
                </button>
              </div>
            </div>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto bg-slate-50 p-16 md:p-24 rounded-[60px] border border-slate-100 relative overflow-hidden shadow-2xl shadow-slate-200/50">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 relative z-10">
            <button className="w-full sm:w-auto px-12 py-5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full font-bold transition-all shadow-xl shadow-emerald-200">
              Explore Courses
            </button>
            <button 
