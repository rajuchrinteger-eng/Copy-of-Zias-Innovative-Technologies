          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 animate-fade-up">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <button className="px-10 py-4 bg-orange-600 hover:bg-orange-700 text-white rounded-full font-bold transition-all shadow-xl shadow-orange-200">
                  Talk to Our Experts
                </button>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-up">
              ...
              <div className="space-y-6 text-lg text-slate-600 leading-relaxed">
                <p>
                  Our Other Business Services are built to address the real-world challenges faced by businesses today. We offer end-to-end support covering marketing, branding, technology, and skill development.
                </p>
                <p>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-4xl mx-auto bg-white border border-slate-200 p-16 md:p-24 rounded-[60px] relative overflow-hidden shadow-2xl shadow-slate-200/50">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 relative z-10">
            <button className="w-full sm:w-auto px-12 py-5 bg-slate-900 text-white rounded-full font-bold hover:bg-slate-800 transition-all shadow-xl">
              Contact Us
            </button>
            <button className="w-full sm:w-auto px-12 py-5 bg-white border border-slate-200 text-slate-900 rounded-full font-bold hover:bg-slate-50 transition-all">
